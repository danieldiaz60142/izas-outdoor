...
const gallerySlide = document.querySelector(".media-gallery__viewer");
if (gallerySlide) {
  document.querySelector(".media-gallery__thumbs ul.media-thumbs").setAttribute("style", "max-height:" + gallerySlide.offsetHeight + 'px');
