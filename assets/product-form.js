if (!customElements.get('product-form')) {
  class ProductForm extends HTMLElement {
    ...
    async handleSubmit(evt) {
      ...
      if(document.getElementById('btn-sticky-add-cart')) {
        document.getElementById('btn-sticky-add-cart').classList.add('is-loading')
        document.getElementById('btn-sticky-add-cart').disabled = true
      }
      ...
      try {
        ...
        if(document.getElementById('btn-sticky-add-cart')) {
          document.getElementById('btn-sticky-add-cart').classList.add('is-success')
        }
        ...
        setTimeout(() => {
          ...
          if(document.getElementById('btn-sticky-add-cart')) {
            document.getElementById('btn-sticky-add-cart').classList.remove('is-loading')
            document.getElementById('btn-sticky-add-cart').classList.remove('is-success')
            document.getElementById('btn-sticky-add-cart').disabled = false
          }
