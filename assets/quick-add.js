...
if (!customElements.get('quick-add-drawer')) {
  class QuickAddDrawer extends SideDrawer {
    ...
    async open(opener) {
      ...
      opener.removeAttribute('aria-disabled');
      if(document.getElementById('livechat-wrapper')) {
        document.getElementById('livechat-wrapper').style.display = 'none'
      }
    }
    ...
    close() {
      ...
      if(document.getElementById('livechat-wrapper')) {
        document.getElementById('livechat-wrapper').style.display = 'block'
      }
    }
